...
import (
	...
	examplecomv1alpha1 "test-project/api/v1alpha1"
	"test-project/internal/controller"
	webhookexamplecomv1alpha1 "test-project/internal/webhook/v1alpha1"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "68e6fb8d.my.domain",
	...
	if os.Getenv("ENABLE_WEBHOOKS") != "false" {
		if err = webhookexamplecomv1alpha1.SetupBusyboxWebhookWithManager(mgr); err != nil {
